        ...
        <div class="col-lg-7 col-md-10">
            ...
            <div class="d-flex align-items-center justify-content-between mb-4">
                <div>
                    <h4 class="mb-1 fw-bold text-dark">
                        </i> Enregistrement d'une Piece
                    </h4>
                    <p class="text-muted small mb-0">Ajoutez une nouvelle pièce détachée au catalogue.</p>
                </div>
            ...
            <div class="card shadow-lg border-0 rounded-4">
                <div class="card-body p-4 p-md-5">
                    <form action="{{ route('pieces.store') }}" method="post" id="pieceForm">
                        @csrf
                        ...
                        <div class="mt-5">
                            <button class="btn btn-primary w-100 btn-lg shadow fw-bold rounded-3 py-3 btn-submit" type="submit">
                                <i class="bi bi-cloud-arrow-up-fill me-2"></i> Finaliser l'enregistrement
                            </button>
                        </div>
                    </form>
                </div>
            ...
            <div class="text-center mt-4">
                <p class="text-muted small">
                    <i class="bi bi-info-circle me-1"></i> Les champs sont obligatoires pour assurer le suivi de maintenance.
                </p>
            </div>
        </div>
    </div>
