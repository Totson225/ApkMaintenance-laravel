            ...
            <div class="row justify-content-center">
                <div class="col-md-8">
                    ...
                    <div class="d-flex align-items-center mb-4">
                        <h4 class="mb-0 fw-bold text-primary">Enregistrer un demandeur</h4>
                    </div>
                            ...
                            <form action="{{ route('demandeurs.store') }}" method="post">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" name="prenom_demandeur" id="prenom_demandeur" placeholder="Periguegnon Sara" 
                                                ...
                                                class="form-control bg-light border-start-0 @error('prenom_demandeur') is-invalid @enderror">
                                        </div>
                                ...
                                <div class="d-grid shadow-sm">
                                    <button class="btn btn-primary btn-lg fw-bold" id="enregistrer" type="submit">
                                        <i class="bi bi-save me-2"></i>Enregistrer le demandeur
                                    </button>
                                </div>
                            </form>
                        </div>
