        ...
        <div class="col-md-8">
            ...
            <div class="d-flex align-items-center justify-content-between mb-4">
                <div class="d-flex align-items-center">
                    <div>
                        <h4 class="mb-0 fw-bold text-dark">Modifier le Demandeur</h4>
                        <p class="text-muted small mb-0">Mise à jour des informations de l'agent</p>
                    </div>
                </div>
            ...
            <div class="card body-glass border-0">
                <div class="card-body p-5">
                    <form action="{{ route('demandeurs.update', $demandeur->id_utilisateur) }}" method="post" id="formEditDemandeur">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="row g-4">
                            ...
                            <div class="col-12">
                                ...
                                <div class="input-group custom-input-group">
                                    ...
                                    <input type="text" name="service_demandeur" id="service_demandeur" placeholder="Ex: Ressources Humaines" 
                            ...
                            <div class="col-12">
                                ...
                                <div class="input-group custom-input-group">
                                    ...
                                    <input type="email" name="email_demandeur" id="email_demandeur" placeholder="nom.prenom@administration.ci" 
...
<style>
    ...
    .custom-input-group { transition: all 0.3s ease; }
    .custom-input-group:focus-within { transform: translateY(-2px); }
...
<script>
    document.getElementById('formEditDemandeur').addEventListener('submit', function() {
